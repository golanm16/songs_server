...
router.post("/register", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var user, hashedPass, user_1, savedUser, e_1;
...
router.post("/login", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var user, match, accessToken, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 3:
                match = _a.sent();
                if (match) {
                    accessToken = jwt.sign(JSON.stringify(user), process.env.TOKEN_SECRET);
                    res.json(accessToken);
                    console.log("user ".concat(user.userName, " logged in"));
                    return [2 /*return*/];
                }
                else {
